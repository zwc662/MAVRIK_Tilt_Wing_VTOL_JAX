...
def create_intropolator(breakpoints: List[jnp.ndarray], values: jnp.ndarray) -> JaxNDInterpolator:
    ndim = len(breakpoints)
    shape = tuple(values.shape)
    corner_offsets = jnp.stack(
        jnp.meshgrid(*[jnp.array([0, 1]) for _ in range(ndim)], indexing="ij"), axis=-1
    ).reshape(-1, ndim).astype(jnp.int32)

    flat_values = values.flatten()
    return JaxNDInterpolator(breakpoints, values, ndim, shape, corner_offsets, flat_values)
...
def interpolate_nd(interpolator: JaxNDInterpolator, inputs: jnp.ndarray) -> float:
    """
    ...
    for i in range(interpolator.ndim):
        idx, weight = get_index_and_weight(inputs[i], interpolator.breakpoints[i])
        indices.append(idx)
    ...
    corner_indices = jnp.clip(corner_indices, 0, jnp.array(interpolator.shape) - 1)

    # Convert n-dimensional indices to flat indices
    flat_corner_indices = jnp.ravel_multi_index(corner_indices.T, interpolator.shape)

    # Gather corner values
    corner_values = interpolator.flat_values[flat_corner_indices]

    # Compute weights for all corners
    corner_weights = jnp.prod(jnp.where(interpolator.corner_offsets, weights, 1 - weights), axis=1)
...
class MavrikAero:
    ...
    def get_Cx_table(self, mavrik_setup: MavrikSetup):
        ...
        self.CX_aileron_wing_lookup_table = create_intropolator(CX_aileron_wing_breakpoints, CX_aileron_wing_value)
        ...
        self.CX_elevator_tail_lookup_table = create_intropolator(CX_elevator_tail_breakpoints, CX_elevator_tail_value)
        ...
        self.CX_flap_wing_lookup_table = create_intropolator(CX_flap_wing_breakpoints, CX_flap_wing_value)
        ...
        self.CX_rudder_tail_lookup_table = create_intropolator(CX_rudder_tail_breakpoints, CX_rudder_tail_value)
        
        CX_tail_breakpoints = [getattr(mavrik_setup, f'CX_tail_{i}') for i in range(1, 1 + 6)]
        CX_tail_value = mavrik_setup.CX_tail_val
        self.CX_tail_lookup_table = create_intropolator(CX_tail_breakpoints, CX_tail_value)
        ...
        self.CX_tail_damp_p_lookup_table = create_intropolator(CX_tail_damp_p_breakpoints, CX_tail_damp_p_value)
        ...
        self.CX_tail_damp_q_lookup_table = create_intropolator(CX_tail_damp_q_breakpoints, CX_tail_damp_q_value)
        ...
        self.CX_tail_damp_r_lookup_table = create_intropolator(CX_tail_damp_r_breakpoints, CX_tail_damp_r_value)

        CX_wing_breakpoints = [getattr(mavrik_setup, f'CX_wing_{i}') for i in range(1, 1 + 6)]
        CX_wing_value = mavrik_setup.CX_wing_val
        self.CX_wing_lookup_table = create_intropolator(CX_wing_breakpoints, CX_wing_value)
        ...
        self.CX_wing_damp_p_lookup_table = create_intropolator(CX_wing_damp_p_breakpoints, CX_wing_damp_p_value)
        ...
        self.CX_wing_damp_q_lookup_table = create_intropolator(CX_wing_damp_q_breakpoints, CX_wing_damp_q_value)
        ...
        self.CX_wing_damp_r_lookup_table = create_intropolator(CX_wing_damp_r_breakpoints, CX_wing_damp_r_value)
        ...
        self.CX_hover_fuse_lookup_table = create_intropolator(CX_hover_fuse_breakpoints, CX_hover_fuse_value)
    ...
    def Cx(self, u: ActuatorOutput, wing_transform: FloatScalar, tail_transform: FloatScalar) -> Forces:
        ...
        CX_aileron_wing = interpolate_nd(self.CX_aileron_wing_lookup_table, jnp.array([
        ...
        CX_elevator_tail = interpolate_nd(self.CX_elevator_tail_lookup_table, jnp.array([
        ...
        CX_flap_wing = interpolate_nd(self.CX_flap_wing_lookup_table, jnp.array([
        ...
        CX_rudder_tail = interpolate_nd(self.CX_rudder_tail_lookup_table, jnp.array([
        ...
        # Tail
        CX_tail = interpolate_nd(self.CX_tail_lookup_table, jnp.array([
        ...
        # Tail Damp p
        CX_tail_damp_p = interpolate_nd(self.CX_tail_damp_p_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta
        ]))
        ...
        # Tail Damp q
        CX_tail_damp_q = interpolate_nd(self.CX_tail_damp_q_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta
        ]))
        ...
        # Tail Damp r
        CX_tail_damp_r = interpolate_nd(self.CX_tail_damp_r_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta
        ]))
        ...
        # Wing
        CX_wing = interpolate_nd(self.CX_wing_lookup_table, jnp.array([
        ...
        # Wing Damp p
        CX_wing_damp_p = interpolate_nd(self.CX_wing_damp_p_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        # Wing Damp q
        CX_wing_damp_q = interpolate_nd(self.CX_wing_damp_q_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        # Wing Damp r
        CX_wing_damp_r = interpolate_nd(self.CX_wing_damp_r_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        # Hover Fuse
        CX_hover_fuse = interpolate_nd(self.CX_hover_fuse_lookup_table, jnp.array([
            u.U, u.alpha, u.beta
        ]))
    ...
    def get_Cy_table(self, mavrik_setup: MavrikSetup):
        ...
        self.CY_aileron_wing_lookup_table = create_intropolator(CY_aileron_wing_breakpoints, CY_aileron_wing_value)
        ...
        self.CY_elevator_tail_lookup_table = create_intropolator(CY_elevator_tail_breakpoints, CY_elevator_tail_value)
        ...
        self.CY_flap_wing_lookup_table = create_intropolator(CY_flap_wing_breakpoints, CY_flap_wing_value)
        ...
        self.CY_rudder_tail_lookup_table = create_intropolator(CY_rudder_tail_breakpoints, CY_rudder_tail_value)

        CY_tail_breakpoints = [getattr(mavrik_setup, f'CY_tail_{i}') for i in range(1, 1 + 6)]
        CY_tail_value = mavrik_setup.CY_tail_val
        self.CY_tail_lookup_table = create_intropolator(CY_tail_breakpoints, CY_tail_value)
        ...
        self.CY_tail_damp_p_lookup_table = create_intropolator(CY_tail_damp_p_breakpoints, CY_tail_damp_p_value)
        ...
        self.CY_tail_damp_q_lookup_table = create_intropolator(CY_tail_damp_q_breakpoints, CY_tail_damp_q_value)
        ...
        self.CY_tail_damp_r_lookup_table = create_intropolator(CY_tail_damp_r_breakpoints, CY_tail_damp_r_value)

        CY_wing_breakpoints = [getattr(mavrik_setup, f'CY_wing_{i}') for i in range(1, 1 + 6)]
        CY_wing_value = mavrik_setup.CY_wing_val
        self.CY_wing_lookup_table = create_intropolator(CY_wing_breakpoints, CY_wing_value)
        ...
        self.CY_wing_damp_p_lookup_table = create_intropolator(CY_wing_damp_p_breakpoints, CY_wing_damp_p_value)
        ...
        self.CY_wing_damp_q_lookup_table = create_intropolator(CY_wing_damp_q_breakpoints, CY_wing_damp_q_value)
        ...
        self.CY_wing_damp_r_lookup_table = create_intropolator(CY_wing_damp_r_breakpoints, CY_wing_damp_r_value)
        ...
        self.CY_hover_fuse_lookup_table = create_intropolator(CY_hover_fuse_breakpoints, CY_hover_fuse_value)
    ...
    def Cy(self, u: ActuatorOutput, wing_transform: FloatScalar, tail_transform: FloatScalar) -> Forces:
        ...
        CY_aileron_wing = interpolate_nd(self.CY_aileron_wing_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta, u.aileron
        ]))
        ...
        CY_elevator_tail = interpolate_nd(self.CY_elevator_tail_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta, u.elevator
        ]))
        ...
        CY_flap_wing = interpolate_nd(self.CY_flap_wing_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta, u.flap
        ]))
        ...
        CY_rudder_tail = interpolate_nd(self.CY_rudder_tail_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta, u.rudder
        ]))
        ...
        # Tail
        CY_tail = interpolate_nd(self.CY_tail_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta
        ]))
        ...
        # Tail Damp p
        CY_tail_damp_p = interpolate_nd(self.CY_tail_damp_p_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta
        ])) 
        ...
        # Tail Damp q
        CY_tail_damp_q = interpolate_nd(self.CY_tail_damp_q_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta
        ]))
        ...
        # Tail Damp r
        CY_tail_damp_r = interpolate_nd(self.CY_tail_damp_r_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta
        ]))
        ...
        # Wing
        CY_wing = interpolate_nd(self.CY_wing_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        # Wing Damp p
        CY_wing_damp_p = interpolate_nd(self.CY_wing_damp_p_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        # Wing Damp q
        CY_wing_damp_q = interpolate_nd(self.CY_wing_damp_q_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        # Wing Damp r
        CY_wing_damp_r = interpolate_nd(self.CY_wing_damp_r_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        # Hover Fuse
        CY_hover_fuse = interpolate_nd(self.CY_hover_fuse_lookup_table, jnp.array([
            u.U, u.alpha, u.beta
        ]))
    ...
    def get_Cz_table(self, mavrik_setup: MavrikSetup):
        ...
        self.CZ_aileron_wing_lookup_table = create_intropolator(CZ_aileron_wing_breakpoints, CZ_aileron_wing_value)
        ...
        self.CZ_elevator_tail_lookup_table = create_intropolator(CZ_elevator_tail_breakpoints, CZ_elevator_tail_value)
        ...
        self.CZ_flap_wing_lookup_table = create_intropolator(CZ_flap_wing_breakpoints, CZ_flap_wing_value)
        ...
        self.CZ_rudder_tail_lookup_table = create_intropolator(CZ_rudder_tail_breakpoints, CZ_rudder_tail_value)

        CZ_tail_breakpoints = [getattr(mavrik_setup, f'CZ_tail_{i}') for i in range(1, 1 + 6)]
        CZ_tail_value = mavrik_setup.CZ_tail_val
        self.CZ_tail_lookup_table = create_intropolator(CZ_tail_breakpoints, CZ_tail_value)
        ...
        self.CZ_tail_damp_p_lookup_table = create_intropolator(CZ_tail_damp_p_breakpoints, CZ_tail_damp_p_value)
        ...
        self.CZ_tail_damp_q_lookup_table = create_intropolator(CZ_tail_damp_q_breakpoints, CZ_tail_damp_q_value)
        ...
        self.CZ_tail_damp_r_lookup_table = create_intropolator(CZ_tail_damp_r_breakpoints, CZ_tail_damp_r_value)

        CZ_wing_breakpoints = [getattr(mavrik_setup, f'CZ_wing_{i}') for i in range(1, 1 + 6)]
        CZ_wing_value = mavrik_setup.CZ_wing_val
        self.CZ_wing_lookup_table = create_intropolator(CZ_wing_breakpoints, CZ_wing_value)
        ...
        self.CZ_wing_damp_p_lookup_table = create_intropolator(CZ_wing_damp_p_breakpoints, CZ_wing_damp_p_value)
        ...
        self.CZ_wing_damp_q_lookup_table = create_intropolator(CZ_wing_damp_q_breakpoints, CZ_wing_damp_q_value)
        ...
        self.CZ_wing_damp_r_lookup_table = create_intropolator(CZ_wing_damp_r_breakpoints, CZ_wing_damp_r_value)
        ...
        self.CZ_hover_fuse_lookup_table = create_intropolator(CZ_hover_fuse_breakpoints, CZ_hover_fuse_value)
    ...
    def Cz(self, u: ActuatorOutput, wing_transform: FloatScalar, tail_transform: FloatScalar) -> Forces:
        ...
        CZ_aileron_wing = interpolate_nd(self.CZ_aileron_wing_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta, u.aileron
        ]))
        ...
        CZ_elevator_tail = interpolate_nd(self.CZ_elevator_tail_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta, u.elevator
        ]))
        ...
        CZ_flap_wing = interpolate_nd(self.CZ_flap_wing_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta, u.flap
        ]))
        ...
        CZ_rudder_tail = interpolate_nd(self.CZ_rudder_tail_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta, u.rudder
        ]))
        ...
        # Tail
        CZ_tail = interpolate_nd(self.CZ_tail_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta
        ]))
        ...
        # Tail Damp p
        CZ_tail_damp_p = interpolate_nd(self.CZ_tail_damp_p_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta
        ]))
        ...
        # Tail Damp q
        CZ_tail_damp_q = interpolate_nd(self.CZ_tail_damp_q_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta
        ]))
        ...
        # Tail Damp r
        CZ_tail_damp_r = interpolate_nd(self.CZ_tail_damp_r_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta
        ]))
        ...
        # Wing
        CZ_wing = interpolate_nd(self.CZ_wing_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        # Wing Damp p
        CZ_wing_damp_p = interpolate_nd(self.CZ_wing_damp_p_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        # Wing Damp q
        CZ_wing_damp_q = interpolate_nd(self.CZ_wing_damp_q_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        # Wing Damp r
        CZ_wing_damp_r = interpolate_nd(self.CZ_wing_damp_r_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        # Hover Fuse
        CZ_hover_fuse = interpolate_nd(self.CZ_hover_fuse_lookup_table, jnp.array([
            u.U, u.alpha, u.beta
        ]))
    ...
    def get_Cl_table(self, mavrik_setup: MavrikSetup):
        ...
        self.Cl_aileron_wing_lookup_table = create_intropolator(Cl_aileron_wing_breakpoints, Cl_aileron_wing_value)
        ...
        self.Cl_elevator_tail_lookup_table = create_intropolator(Cl_elevator_tail_breakpoints, Cl_elevator_tail_value)
        ...
        self.Cl_flap_wing_lookup_table = create_intropolator(Cl_flap_wing_breakpoints, Cl_flap_wing_value)
        ...
        self.Cl_rudder_tail_lookup_table = create_intropolator(Cl_rudder_tail_breakpoints, Cl_rudder_tail_value)

        Cl_tail_breakpoints = [getattr(mavrik_setup, f'Cl_tail_{i}') for i in range(1, 1 + 6)]
        Cl_tail_value = mavrik_setup.Cl_tail_val
        self.Cl_tail_lookup_table = create_intropolator(Cl_tail_breakpoints, Cl_tail_value)
        ...
        self.Cl_tail_damp_p_lookup_table = create_intropolator(Cl_tail_damp_p_breakpoints, Cl_tail_damp_p_value)
        ...
        self.Cl_tail_damp_q_lookup_table = create_intropolator(Cl_tail_damp_q_breakpoints, Cl_tail_damp_q_value)
        ...
        self.Cl_tail_damp_r_lookup_table = create_intropolator(Cl_tail_damp_r_breakpoints, Cl_tail_damp_r_value)

        Cl_wing_breakpoints = [getattr(mavrik_setup, f'Cl_wing_{i}') for i in range(1, 1 + 6)]
        Cl_wing_value = mavrik_setup.Cl_wing_val
        self.Cl_wing_lookup_table = create_intropolator(Cl_wing_breakpoints, Cl_wing_value)
        ...
        self.Cl_wing_damp_p_lookup_table = create_intropolator(Cl_wing_damp_p_breakpoints, Cl_wing_damp_p_value)
        ...
        self.Cl_wing_damp_q_lookup_table = create_intropolator(Cl_wing_damp_q_breakpoints, Cl_wing_damp_q_value)
        ...
        self.Cl_wing_damp_r_lookup_table = create_intropolator(Cl_wing_damp_r_breakpoints, Cl_wing_damp_r_value)
        ...
        self.Cl_hover_fuse_lookup_table = create_intropolator(Cl_hover_fuse_breakpoints, Cl_hover_fuse_value)
    ...
    def L(self, u: ActuatorOutput, wing_transform: FloatScalar, tail_transform: FloatScalar) -> Moments:
        ...
        Cl_aileron_wing = interpolate_nd(self.Cl_aileron_wing_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta, u.aileron
        ]))
        ...
        Cl_elevator_tail = interpolate_nd(self.Cl_elevator_tail_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta, u.elevator
        ]))
        ...
        Cl_flap_wing = interpolate_nd(self.Cl_flap_wing_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta, u.flap
        ]))
        ...
        Cl_rudder_tail = interpolate_nd(self.Cl_rudder_tail_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta, u.rudder
        ]))
        ...
        # Tail
        Cl_tail = interpolate_nd(self.Cl_tail_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta
        ]))
        ...
        # Tail Damp p
        Cl_tail_damp_p = interpolate_nd(self.Cl_tail_damp_p_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta
        ]))
        ...
        # Tail Damp q
        Cl_tail_damp_q = interpolate_nd(self.Cl_tail_damp_q_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta
        ]))
        ...
        # Tail Damp r
        Cl_tail_damp_r = interpolate_nd(self.Cl_tail_damp_r_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta
        ]))
        ...
        # Wing
        Cl_wing = interpolate_nd(self.Cl_wing_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        # Wing Damp p
        Cl_wing_damp_p = interpolate_nd(self.Cl_wing_damp_p_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        # Wing Damp q
        Cl_wing_damp_q = interpolate_nd(self.Cl_wing_damp_q_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        # Wing Damp r
        Cl_wing_damp_r = interpolate_nd(self.Cl_wing_damp_r_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        # Hover Fuse
        Cl_hover_fuse = interpolate_nd(self.Cl_hover_fuse_lookup_table, jnp.array([
            u.U, u.alpha, u.beta
        ]))
    ...
    def get_Cm_table(self, mavrik_setup: MavrikSetup):
        ...
        self.Cm_aileron_wing_lookup_table = create_intropolator(Cm_aileron_wing_breakpoints, Cm_aileron_wing_value)
        ...
        self.Cm_elevator_tail_lookup_table = create_intropolator(Cm_elevator_tail_breakpoints, Cm_elevator_tail_value)
        ...
        self.Cm_flap_wing_lookup_table = create_intropolator(Cm_flap_wing_breakpoints, Cm_flap_wing_value)
        ...
        self.Cm_rudder_tail_lookup_table = create_intropolator(Cm_rudder_tail_breakpoints, Cm_rudder_tail_value)

        Cm_tail_breakpoints = [getattr(mavrik_setup, f'Cm_tail_{i}') for i in range(1, 1 + 6)]
        Cm_tail_value = mavrik_setup.Cm_tail_val
        self.Cm_tail_lookup_table = create_intropolator(Cm_tail_breakpoints, Cm_tail_value)
        ...
        self.Cm_tail_damp_p_lookup_table = create_intropolator(Cm_tail_damp_p_breakpoints, Cm_tail_damp_p_value)
        ...
        self.Cm_tail_damp_q_lookup_table = create_intropolator(Cm_tail_damp_q_breakpoints, Cm_tail_damp_q_value)
        ...
        self.Cm_tail_damp_r_lookup_table = create_intropolator(Cm_tail_damp_r_breakpoints, Cm_tail_damp_r_value)

        Cm_wing_breakpoints = [getattr(mavrik_setup, f'Cm_wing_{i}') for i in range(1, 1 + 6)]
        Cm_wing_value = mavrik_setup.Cm_wing_val
        self.Cm_wing_lookup_table = create_intropolator(Cm_wing_breakpoints, Cm_wing_value)
        ...
        self.Cm_wing_damp_p_lookup_table = create_intropolator(Cm_wing_damp_p_breakpoints, Cm_wing_damp_p_value)
        ...
        self.Cm_wing_damp_q_lookup_table = create_intropolator(Cm_wing_damp_q_breakpoints, Cm_wing_damp_q_value)
        ...
        self.Cm_wing_damp_r_lookup_table = create_intropolator(Cm_wing_damp_r_breakpoints, Cm_wing_damp_r_value)
        ...
        self.Cm_hover_fuse_lookup_table = create_intropolator(Cm_hover_fuse_breakpoints, Cm_hover_fuse_value)
    ...
    def M(self, u: ActuatorOutput, wing_transform: FloatScalar, tail_transform: FloatScalar) -> Moments:
        ...
        Cm_aileron_wing = interpolate_nd(self.Cm_aileron_wing_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta, u.aileron
        ]))
        ...
        Cm_elevator_tail = interpolate_nd(self.Cm_elevator_tail_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta, u.elevator
        ]))
        ...
        Cm_flap_wing = interpolate_nd(self.Cm_flap_wing_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta, u.flap
        ]))
        ...
        Cm_rudder_tail = interpolate_nd(self.Cm_rudder_tail_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta, u.rudder
        ]))
        ...
        # Tail
        Cm_tail = interpolate_nd(self.Cm_tail_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta
        ]))
        ...
        # Tail Damp p
        Cm_tail_damp_p = interpolate_nd(self.Cm_tail_damp_p_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta
        ]))
        ...
        # Tail Damp q
        Cm_tail_damp_q = interpolate_nd(self.Cm_tail_damp_q_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta
        ]))
        ...
        # Tail Damp r
        # Tail Damp r
        Cm_tail_damp_r = interpolate_nd(self.Cm_tail_damp_r_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta
        ]))
        ...
        # Wing
        Cm_wing = interpolate_nd(self.Cm_wing_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        # Wing Damp p
        Cm_wing_damp_p = interpolate_nd(self.Cm_wing_damp_p_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        # Wing Damp q
        Cm_wing_damp_q = interpolate_nd(self.Cm_wing_damp_q_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        # Wing Damp r
        Cm_wing_damp_r = interpolate_nd(self.Cm_wing_damp_r_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        # Hover Fuse
        Cm_hover_fuse = interpolate_nd(self.Cm_hover_fuse_lookup_table, jnp.array([
            u.U, u.alpha, u.beta
        ]))
    ...
    def get_Cn_table(self, mavrik_setup: MavrikSetup):
        ...
        self.Cn_aileron_wing_lookup_table = create_intropolator(Cn_aileron_wing_breakpoints, Cn_aileron_wing_value)
        ...
        self.Cn_elevator_tail_lookup_table = create_intropolator(Cn_elevator_tail_breakpoints, Cn_elevator_tail_value)
        ...
        self.Cn_flap_wing_lookup_table = create_intropolator(Cn_flap_wing_breakpoints, Cn_flap_wing_value)
        ...
        self.Cn_rudder_tail_lookup_table = create_intropolator(Cn_rudder_tail_breakpoints, Cn_rudder_tail_value)
        
        Cn_tail_breakpoints = [getattr(mavrik_setup, f'Cn_tail_{i}') for i in range(1, 1 + 6)]
        Cn_tail_value = mavrik_setup.Cn_tail_val
        self.Cn_tail_lookup_table = create_intropolator(Cn_tail_breakpoints, Cn_tail_value)
        ...
        self.Cn_tail_damp_p_lookup_table = create_intropolator(Cn_tail_damp_p_breakpoints, Cn_tail_damp_p_value)
        ...
        self.Cn_tail_damp_q_lookup_table = create_intropolator(Cn_tail_damp_q_breakpoints, Cn_tail_damp_q_value)
        ...
        self.Cn_tail_damp_r_lookup_table = create_intropolator(Cn_tail_damp_r_breakpoints, Cn_tail_damp_r_value)

        Cn_wing_breakpoints = [getattr(mavrik_setup, f'Cn_wing_{i}') for i in range(1, 1 + 6)]
        Cn_wing_value = mavrik_setup.Cn_wing_val
        self.Cn_wing_lookup_table = create_intropolator(Cn_wing_breakpoints, Cn_wing_value)
        ...
        self.Cn_wing_damp_p_lookup_table = create_intropolator(Cn_wing_damp_p_breakpoints, Cn_wing_damp_p_value)
        ...
        self.Cn_wing_damp_q_lookup_table = create_intropolator(Cn_wing_damp_q_breakpoints, Cn_wing_damp_q_value)
        ...
        self.Cn_wing_damp_r_lookup_table = create_intropolator(Cn_wing_damp_r_breakpoints, Cn_wing_damp_r_value)
        ...
        self.Cn_hover_fuse_lookup_table = create_intropolator(Cn_hover_fuse_breakpoints, Cn_hover_fuse_value)
    ...
    def N(self, u: ActuatorOutput, wing_transform: FloatScalar, tail_transform: FloatScalar) -> Moments:
        ...
        Cn_aileron_wing = interpolate_nd(self.Cn_aileron_wing_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta, u.aileron
        ]))
        ...
        Cn_elevator_tail = interpolate_nd(self.Cn_elevator_tail_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta, u.elevator
        ]))
        ...
        Cn_flap_wing = interpolate_nd(self.Cn_flap_wing_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta, u.flap
        ]))
        ...
        Cn_rudder_tail = interpolate_nd(self.Cn_rudder_tail_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta, u.rudder
        ]))
        ...
        # Tail
        Cn_tail = interpolate_nd(self.Cn_tail_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta
        ]))
        ...
        # Tail Damp p
        Cn_tail_damp_p = interpolate_nd(self.Cn_tail_damp_p_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta
        ]))
        ...
        # Tail Damp q
        Cn_tail_damp_q = interpolate_nd(self.Cn_tail_damp_q_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta
        ]))
        ...
        # Tail Damp r
        Cn_tail_damp_r = interpolate_nd(self.Cn_tail_damp_r_lookup_table, jnp.array([
            u.tail_alpha, u.tail_beta, u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta
        ]))
        ...
        # Wing
        Cn_wing = interpolate_nd(self.Cn_wing_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        # Wing Damp p
        Cn_wing_damp_p = interpolate_nd(self.Cn_wing_damp_p_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        # Wing Damp q
        Cn_wing_damp_q = interpolate_nd(self.Cn_wing_damp_q_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        # Wing Damp r
        Cn_wing_damp_r = interpolate_nd(self.Cn_wing_damp_r_lookup_table, jnp.array([
            u.wing_alpha, u.wing_beta, u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        # Hover Fuse
        Cn_hover_fuse = interpolate_nd(self.Cn_hover_fuse_lookup_table, jnp.array([
            u.U, u.alpha, u.beta
        ]))
    ...
    def get_Ct_table(self, mavrik_setup: MavrikSetup):
        ...
        self.Ct_tail_left_lookup_table = create_intropolator(Ct_tail_left_breakpoints, Ct_tail_left_value)
        ...
        self.Ct_tail_right_lookup_table = create_intropolator(Ct_tail_right_breakpoints, Ct_tail_right_value)
        ...
        self.Ct_left_6_in_lookup_table = create_intropolator(Ct_left_6_in_breakpoints, Ct_left_6_in_value)
        ...
        self.Ct_right_7_in_lookup_table = create_intropolator(Ct_right_7_in_breakpoints, Ct_right_7_in_value)
        ...
        self.Ct_right_8_lookup_table = create_intropolator(Ct_right_8_breakpoints, Ct_right_8_value)
        ...
        self.Ct_right_9_lookup_table = create_intropolator(Ct_right_9_breakpoints, Ct_right_9_value)
        ...
        self.Ct_right_10_lookup_table = create_intropolator(Ct_right_10_breakpoints, Ct_right_10_value)
        ...
        self.Ct_right_11_lookup_table = create_intropolator(Ct_right_11_breakpoints, Ct_right_11_value)
        ...
        self.Ct_right_12_out_lookup_table = create_intropolator(Ct_right_12_out_breakpoints, Ct_right_12_out_value)
    ...
    def Ct(self, u: ActuatorOutput, wing_transform: FloatScalar, tail_transform: FloatScalar) -> Tuple[Forces, Moments]:
        Ct_tail_left = interpolate_nd(self.Ct_tail_left_lookup_table, jnp.array([
        ...
        Ct_tail_right = interpolate_nd(self.Ct_tail_right_lookup_table, jnp.array([
            u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta
        ]))
        ...
        Ct_left_out1 = interpolate_nd(self.Ct_left_out1_lookup_table, jnp.array([
        ...
        Ct_left_2 = interpolate_nd(self.Ct_left_2_lookup_table, jnp.array([
            u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        Ct_left_3 = interpolate_nd(self.Ct_left_3_lookup_table, jnp.array([
            u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        Ct_left_4 = interpolate_nd(self.Ct_left_4_lookup_table, jnp.array([
            u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        Ct_left_5 = interpolate_nd(self.Ct_left_5_lookup_table, jnp.array([
            u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        Ct_left_6_in = interpolate_nd(self.Ct_left_6_in_lookup_table, jnp.array([
            u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        Ct_right_7_in = interpolate_nd(self.Ct_right_7_in_lookup_table, jnp.array([
            u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        Ct_right_8 = interpolate_nd(self.Ct_right_8_lookup_table, jnp.array([
            u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        Ct_right_9 = interpolate_nd(self.Ct_right_9_lookup_table, jnp.array([
            u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        Ct_right_10 = interpolate_nd(self.Ct_right_10_lookup_table, jnp.array([
            u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        Ct_right_11 = interpolate_nd(self.Ct_right_11_lookup_table, jnp.array([
            u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        Ct_right_12_out = interpolate_nd(self.Ct_right_12_out_lookup_table, jnp.array([
            u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
    ...
    def get_Kq_table(self, mavrik_setup: MavrikSetup):
        ...
        self.Kq_tail_left_lookup_table = create_intropolator(Kq_tail_left_breakpoints, Kq_tail_left_value)
        ...
        self.Kq_tail_right_lookup_table = create_intropolator(Kq_tail_right_breakpoints, Kq_tail_right_value)
        ...
        self.Kq_left_6_in_lookup_table = create_intropolator(Kq_left_6_in_breakpoints, Kq_left_6_in_value)
        ...
        self.Kq_right_7_in_lookup_table = create_intropolator(Kq_right_7_in_breakpoints, Kq_right_7_in_value)
        ...
        self.Kq_right_8_lookup_table = create_intropolator(Kq_right_8_breakpoints, Kq_right_8_value)
        ...
        self.Kq_right_9_lookup_table = create_intropolator(Kq_right_9_breakpoints, Kq_right_9_value)
        ...
        self.Kq_right_10_lookup_table = create_intropolator(Kq_right_10_breakpoints, Kq_right_10_value)
        ...
        self.Kq_right_11_lookup_table = create_intropolator(Kq_right_11_breakpoints, Kq_right_11_value)
        ...
        self.Kq_right_12_out_lookup_table = create_intropolator(Kq_right_12_out_breakpoints, Kq_right_12_out_value)

    def Kq(self, u: ActuatorOutput, wing_transform: FloatScalar, tail_transform: FloatScalar) -> Moments:
        Kq_tail_left = interpolate_nd(self.Kq_tail_left_lookup_table, jnp.array([
            u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta
        ]))
        ...
        Kq_tail_right = interpolate_nd(self.Kq_tail_right_lookup_table, jnp.array([
            u.U, u.tail_RPM, u.tail_prop_alpha, u.tail_prop_beta
        ]))
        ...
        Kq_left_out = interpolate_nd(self.Kq_left_out_lookup_table, jnp.array([
            u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        Kq_left_2 = interpolate_nd(self.Kq_left_2_lookup_table, jnp.array([
            u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        Kq_left_3 = interpolate_nd(self.Kq_left_3_lookup_table, jnp.array([
            u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        Kq_left_4 = interpolate_nd(self.Kq_left_4_lookup_table, jnp.array([
            u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        Kq_left_5 = interpolate_nd(self.Kq_left_5_lookup_table, jnp.array([
            u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        Kq_left_6_in = interpolate_nd(self.Kq_left_6_in_lookup_table, jnp.array([
            u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        Kq_right_7_in = interpolate_nd(self.Kq_right_7_in_lookup_table, jnp.array([
            u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        Kq_right_8 = interpolate_nd(self.Kq_right_8_lookup_table, jnp.array([
            u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        Kq_right_9 = interpolate_nd(self.Kq_right_9_lookup_table, jnp.array([
            u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        Kq_right_10 = interpolate_nd(self.Kq_right_10_lookup_table, jnp.array([
            u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        Kq_right_11 = interpolate_nd(self.Kq_right_11_lookup_table, jnp.array([
            u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
        ...
        Kq_right_12_out = interpolate_nd(self.Kq_right_12_out_lookup_table, jnp.array([
            u.U, u.wing_RPM, u.wing_prop_alpha, u.wing_prop_beta
        ]))
